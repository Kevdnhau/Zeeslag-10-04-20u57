class SchipSpeler2
{
  ...
  float destr2x = 940+160;
  float destr2y = 417;
  float destroyer2X = 940+160;
  float destroyer2Y = 417;
  ...
  float sub2x = 940+162;
  float sub2y = 492;
  float submarine2X = 940+162;
  float submarine2Y = 492;
  ...
  private void boatSelection () {    
    if (boatSelectionPalet2 == true) {
      ...
      rect(980, 100, 215, 40);
      for (int i=0; i<5; i++) {        
        rect(980, 175 + 75 * i, 215, 65);
      }
      textSize(30); 
      textAlign (LEFT, TOP);
      fill (0);
      text("Boat Selection", 980, 100);
    }
  }
